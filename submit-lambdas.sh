...
aws s3 cp launch-function.zip s3://hpcic-tutorials/slackbot-ec2/launch-function.zip
...
cd ..
aws s3 cp notify-function.zip s3://hpcic-tutorials/slackbot-ec2/notify-function.zip
rm -rf notify-package
rm notify-function.zip

# cleanup function
zip cleanup-tasks-function.zip cleanup-tasks-function.py
aws s3 cp cleanup-tasks-function.zip s3://hpcic-tutorials/slackbot-ec2/cleanup-tasks-function.zip
